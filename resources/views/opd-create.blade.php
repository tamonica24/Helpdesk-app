            ...
            <div class="card">
                ...
                <form action="{{ route('opd.store') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_opd" id="kode_opd" class="form-control"
                            @error('kode_opd') is-invalid
                        @enderror" value="{{ old('kode_opd') }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_opd" id="kode_opd" class="form-control"
                            @error('nama_opd') is-invalid
                        @enderror" value="{{ old('nama_opd') }}"
